...
- IP address should match printer at `192.168.1.XXX`
...
**Important**: This macro must exist in Klipper config at `printer@192.168.1.XXX:~/printer_ender3v2_data/config/`
