...
# OrcaSlicer machine profile shows: 192.168.1.XXX:7125
# Klipper SSH: printer@192.168.1.XXX
...
ssh printer@192.168.1.XXX "systemctl status moonraker"

# Should show: active (running)

# 3. Test Moonraker API directly
curl http://192.168.1.XXX:7125/server/info

# Should return JSON with server info

# 4. Check firewall
ssh printer@192.168.1.XXX "sudo ufw status"
...
ssh printer@192.168.1.XXX "cat ~/printer_ender3v2_data/config/klipper-macros/start_end.cfg" | grep -A 20 "START_PRINT"
