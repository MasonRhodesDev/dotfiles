...
1. **[E3V2] Ender-3 V2** (machine) - Configured for Klipper at 192.168.1.XXX:7125
...
- **Host**: `192.168.1.XXX:7125`
- **Note**: This should match `printer@192.168.1.XXX` from the klipper skill

### Important Considerations

1. **G-code Macros**: Machine profile includes START_PRINT and END_PRINT macros that must exist in Klipper config
2. **Print Host Address**: Verify IP `192.168.1.XXX` resolves to printer at `192.168.1.XXX`
