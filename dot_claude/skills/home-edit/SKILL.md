---
name: home-edit
description: Use this skill when editing files in the home directory (~/) or .config directory. Automatically checks chezmoi management status and routes edits to the correct location. ALWAYS check chezmoi before editing.
---
...
## CRITICAL: Always Check Chezmoi First

**BEFORE making ANY edits**, you MUST run:
```bash
chezmoi managed
```
